...
from .utils import scalar, real, clamp
...
class ScrollableFrame(Widget):
	...
	def __init__(self, parent, name=None, base_color=None, text="", font=None,
		...
		#viewport
		self.view = Frame(self.container, size=[1-(border_size*2), 1-(border_size*2)], pos=[0, 0], clip=True, options=BGUI_NO_THEME | BGUI_CENTERED)
	...
	def _horizontal_scrollbar_active(self, widget):
		minX = self.horizontal_scrollbar.parent.position[0]-xdiff
		maxX = (self.horizontal_scrollbar.parent.position[0]+self.horizontal_scrollbar.parent.size[0])- self.horizontal_scrollbar.size[0]
